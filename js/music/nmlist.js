...
var NM = {
  ...
  render: function() {
    ...
    var str = '<div id="nmlist"><h2>牧云云的歌单</h2><i class="icon" data-start="&#x261e;" data-pause="&#xe600;"></i><ul>';
...
$.fn.dragmove = function() {
  return this.each(function() {
    ...
    $this.on('mousedown touchstart', function(e) {
      ...
      if (e.type == 'mousedown') { click = $this; }
      if (e.type == 'touchstart') { touch = $this; }
